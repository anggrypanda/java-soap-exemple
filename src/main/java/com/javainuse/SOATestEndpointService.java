 ...
 * 2020-12-18T13:43:18.060+02:00
 * Generated source version: 3.4.1
 *
 */
@WebServiceClient(name = "SOATestEndpointService",
                  wsdlLocation = "file:/C:/Users/nexttech/Projects/java-soap-exemple/src/main/resources/wsdl/test.wsdl",
...
public class SOATestEndpointService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/nexttech/Projects/java-soap-exemple/src/main/resources/wsdl/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOATestEndpointService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/nexttech/Projects/java-soap-exemple/src/main/resources/wsdl/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
